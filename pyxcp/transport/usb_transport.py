...
class Usb(BaseTransport):
    ...
    def listen(self):
        """Process packets received from the USB device.
        ...
        USB packets, and processes multiple messages that may be contained
        in a single USB packet. It also includes periodic sleep to prevent
        CPU hogging.
        """
        ...
        while True:
            ...
            try:
                ...
                self.logger.error(f"Error in USB listen thread: {e}")
